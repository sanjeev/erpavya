        ...
        <table className="w-full table-auto">
          ...
          {data.length ? data.map((value) => (
            <tr key={value._id}>
              ...
              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <p className="text-black dark:text-white">{value.question}</p>
              </td>

              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <p className="text-black dark:text-white">{value.answer}</p>
              </td>

              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                {value.parent ? (<p className="text-black dark:text-white">{value.parent.question}</p>) : '--'}
              </td>
