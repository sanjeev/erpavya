...
import { postWithoutToken } from '../../helpers/api';
...
import { LoginAPIURL } from '../../helpers/api_config.js';
...
const SignIn = () => {
  ...
  const handleKeyPress = (e, formikProps) => {
    if (e.key === 'Enter') {
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Empowering Users : Secure Access to Your Dashboard
              </p>
